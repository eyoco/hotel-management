	...
	<body>
		<div id = "container">
			<div id = "header">
				...
				<div id = "navbar">
					<form action="process-update-eventBooking.php"
...
include 'connect.php';
$conn = OpenCon();
$result = $conn->query("select orderNumber, bookDate, eventRoomNumber, numberParticipants from
eventBooking");
echo "<select name='id'>";
while ($row = $result->fetch_assoc())
{
unset($orderNumber, $bookDate, $eventRoomNumber, $numberParticipants);
$orderNumber = $row['orderNumber'];
$bookDate = $row['bookDate'];
$eventRoomNumber = $row['eventRoomNumber'];
