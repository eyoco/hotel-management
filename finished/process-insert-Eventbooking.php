...
<?php
include 'connect.php';
$eventRoomNumber = $_POST['id'];
$bookDate = $_POST['bookDate'];
$numberParticipants = $_POST['numberParticipants'];
$price = $_POST['price'];
$conn = OpenCon();
$sql = "insert into eventBooking (eventRoomNumber, bookDate, numberParticipants, price) 
		values('$eventRoomNumber', '$bookDate', '$numberParticipants', '$price')";
if ($conn->query($sql) ===
