...
$id = $_POST['id'];
$conn = OpenCon();
$sql = "SELECT DISTINCT eventBooking.orderNumber, eventBooking.bookDate, eventBooking.eventRoomNumber, groupBooking.numberParticipants, eventBooking.price
FROM eventBooking
INNER JOIN groupBooking WHERE groupBooking.numberParticipants = '$id' AND eventBooking.numberParticipants = groupBooking.numberParticipants";
